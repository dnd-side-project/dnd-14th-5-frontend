  ...
  return (
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-8 px-6 py-10">
      <header className="flex flex-col gap-2">
        ...
        <p className="text-body-s text-g-0/70">
      ...
      <section className="flex flex-col gap-4 rounded-2xl border border-g-0/10 bg-g-700 px-6 py-6">
        <div className="flex flex-col gap-2">
          <label htmlFor="test-auth-email" className="text-body-s text-g-0/80">
            Email
          </label>
          <input
            id="test-auth-email"
            ...
            className="rounded-lg border border-g-0/20 bg-transparent px-4 py-3 text-body-s text-g-0 placeholder:text-g-0/40 focus:outline-none"
        ...
        {errorMessage ? (
          <p className="rounded-lg border border-red-500/40 bg-red-500/10 px-4 py-3 text-body-s text-red-200">
            {errorMessage}
          </p>
        ) : null}
      </section>
